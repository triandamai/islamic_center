                ...
                child: inputCodeOTP
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                              ...
                              width: 300,
                              child:
                                  Image.asset("assets/images/header_splas.png"),
                            ),
                            SizedBox(
                              height: 10,
                            ),
                    ...
                    : Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            margin:
                                EdgeInsets.only(left: 25, right: 25, bottom: 0),
                            child: PinPut(
                              onSubmit: (String val) {
                                codeOtp = val;
                              },
...
//verifikasi nomer
  void _VerifyNomer() async {
    ...
    final PhoneVerificationCompleted verificationCompleted =
      ...
      setState(() {
        print("terima auth nomer : $phoneAuthCredential");
      });
    };
    ...
    await _auth
      ...
      getUser().then((user) {
        if (user != null) {
          auth
              .setCurrentUser(currentUser(uid: user.uid, loginStatus: true))
              .then((_) {
  ...
  void _signInWithGoogle() async {
    ...
    if (user != null) {
      ...
      currentUser curr = new currentUser(
          ...
          photoUrl: "",
          displayName: "");
      await auth.setCurrentUser(curr).then((_) {
        Navigator.pushReplacementNamed(context, '/home');
      });
    } else {
      Fluttertoast.showToast(
